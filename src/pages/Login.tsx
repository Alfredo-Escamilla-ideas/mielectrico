...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-jaecoo-base flex relative overflow-hidden">
      ...
      {/* Background: diagonal grid (full screen) */}
      ...
      {/* ── LEFT PANEL — branding (solo visible en md+) ────────────────────── */}
      <div className="hidden md:flex md:w-1/2 lg:w-3/5 flex-col justify-between p-10 lg:p-16 relative">
        {/* Glow orb izquierda */}
        ...
        <div className="relative space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-jaecoo-secondary text-lg max-w-md leading-relaxed">
              Registra cargas, repostajes y kilómetros. Analiza tu consumo real con datos precisos adaptados a vehículos EV, PHEV e híbridos enchufables.
            </p>
          </div>
      ...
      <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col items-center justify-center p-6 md:p-10 relative">
        ...
        <div className="relative w-full max-w-sm animate-fade-in">
          ...
          {/* Header branding — solo visible en móvil */}
